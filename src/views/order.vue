						...
						<div class="account-order">
							<div class="gray-box">
								...
								<div class="js-list-inner">
									<div class="box-inner order-cart order-list-cart clear" v-for="(item,index) in orderdata" :key='index'>
										<div class="gray-sub-title cart-title">
											<span class="date">{{item.dateinfo}}</span>
											<span class="order-id"> 订单号： <a href="javascript:;">{{item.dingdaninfo}}</a> </span>
											
											<span class="order-detail"><router-link :to="{path:'/payment',query:{orderId:item.dingdaninfo}}">查看详情&gt;</router-link> </span> 
											<span class="sub-total">应付总额</span>
											<span class="num">数量</span>
											<span class="price">单价</span>
										</div>
										<div class="cart">
											<div class="cart-items clear" v-for="(goods,index) in item.checkoutcartdata" :key='index'>
												<div class="prod-info clear">
													<div class="items-thumb">
														<a href="javascript:;" target="_blank"><img :src="goods.productImage"></a>
													</div>
													<div class="items-params clear">
														<div class="name vh-center">
															<a href="javascript:;">{{goods.productName}}</a>
														</div>
														<div class="detail"></div>
													</div>
													<div class="num">{{goods.productNum}}</div>
										...
										<div class="prod-operation">
											<div class="total">¥ {{item.zjinfo}}</div>
											
											<div class="status" v-if="!item.isPay"><router-link :to="{path:'/payment',query:{orderId:item.dingdaninfo}}" class="blue-small-btn js-payment-order">现在付款</router-link></div>
											<div class="status" v-else><router-link :to="{path:'/payment',query:{orderId:item.dingdaninfo}}" class="blue-small-btn js-payment-order">已付款</router-link></div>
										</div>
									</div>
								</div>
							</div>
