										...
										<div class="dialog-inner js-address-add">
												<div class="save-address-box">
														<div class="address-form">
																...
																<div class="module-form-row">
																		<div class="form-item-v3">
																				<input type="text" class="js-verify" placeholder="手机号" v-model="receive.phone">
																				<div class="verify-error"></div>
																		</div>
																</div>
																...
																<div class="module-form-row clear">
																		<div class="form-item-v3 select-item city-wrapper fn-left form-focus-item">
																				<select class="city select-city js-form-city js-verify" v-model="receive.city">
																		...
																		<div class="form-item-v3 select-item district-wrapper fn-right form-focus-item">
																				<select class="city select-city js-form-city js-verify" v-model="receive.county">
																...
																<div class="module-form-row fn-clear">
																		<input type="checkbox" v-model="receive.checked">
...
<script>
	...
	export default {
		...
		methods:{
			...
			submitadd(){
				this.$http.post('/api/cart/address',this.receive)
				.then(res=>{
		...
		computed:{
			cityList(){
				...
				this.addList.forEach(item=>{
					if(item.name==this.receive.province){
						citylist=item.city
					}
				})
				return citylist
			...
			countyList(){
				...
				this.cityList.forEach(item=>{
					if(item.name==this.receive.city){
